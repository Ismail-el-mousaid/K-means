...
kmeans = KMeans(algorithm='auto', copy_x=True, init='k-means++', max_iter=300,
    n_clusters=3, n_init=10, n_jobs=1, precompute_distances='auto',   #n_clusters : determine nbr cluster (group)
    random_state=None, tol=0.0001, verbose=0)


kmeans.fit(X)
#Récupérer les coordonnées des centers
...
#Pour determiner le nbr de cluster qu'il est bon
...
plt.show()
#Pour cet dataset, il faut avoir 3 clusters 
